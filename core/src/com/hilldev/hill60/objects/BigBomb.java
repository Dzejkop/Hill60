...
public class BigBomb extends GameObject {
    ...
    public BigBomb(IEngine engine, int x, int y) {
        ...
        this.addComponent(new SpriteRenderer(manager.getSprite(CharacterScript.ITEM_LIST[3]), 0, 0, 0.6f, 2));
        this.addComponent(new WorldPosition(0, 0));
        this.addComponent(new BoardPosition(x, y));
        this.addComponent(new ExplosionSpawn(100, CharacterScript.ITEM_POWER_LIST[3]));
        this.addComponent(new Visibility());
        this.addComponent(new SoundTrigger(CharacterScript.ITEM_SOUND_LIST[3], 100));
